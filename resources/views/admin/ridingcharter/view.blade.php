        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Riding Charter Details</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<section class="content">
 ...
 <div class="modal fade" id="profile">
        ...
        <!-- SELECT2 EXAMPLE -->
          <form action="{{route('admin.update_ridingcharter')}}" method="post">
                @csrf
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
             ...
             <input type="hidden" class="form-control" name="riding_charter_id" id="exampleInputEmail1" value="<?php echo $info->id; ?>">
